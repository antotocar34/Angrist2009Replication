...
// Eliminate those students that did not show up
keep if noshow==0
...
// What does this do?
// Sets the following variables to none if student was 
// in academic probation in their first year.
...
// We will be operating on the following variables.
...
local i=0
mat t8=J(13,6,.) // Constant variable matrix of dimension 13 x 6
